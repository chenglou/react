...
describe('ReactDOMComponent', function() {
  ...
  describe('updateDOM', function() {
    ...
    it("should give one deprecation warning for directly setting data-* and aria-*", () => {
      spyOn(console, 'warn');
      var message = 'Warning: Direct usage of data-* and aria-* is being deprecated. Use ' +
    ...
    it("should mix data-*, dataSet.*, aria-* and ariaSet correctly", () => {
      ...
      var instance1 = ReactTestUtils.renderIntoDocument(
        <div data-foo-bar="a" dataSet={{fooBar: 'b'}} aria-foo-bar="c" ariaSet={{fooBar: 'd'}} />
      ).getDOMNode();

      var instance2 = ReactTestUtils.renderIntoDocument(
        <div ariaSet={{fooBar: 'd'}} aria-foo-bar="c" dataSet={{fooBar: 'b'}} data-foo-bar="a" />
      ).getDOMNode();
    ...
    it("should handle dataSet as data-* and ariaSet as aria-*", () => {
      var stub = ReactTestUtils.renderIntoDocument(<div dataSet={{}} ariaSet={{}} />);
      var instance = stub.getDOMNode();

      var dataSetup = {id: 42, firstName: 'Douglas'};
      var ariaSetup = {id: 47, firstName: 'John'};
      stub.receiveComponent({props: {dataSet: dataSetup, ariaSet: ariaSetup}}, transaction);
      ...
      var ariaReset = {id: ''};
      stub.receiveComponent({props: {dataSet: dataReset, ariaSet: ariaReset}}, transaction);
    ...
    it("should update data if initially null", () => {
      var stub = ReactTestUtils.renderIntoDocument(<div dataSet={null} ariaSet={null} />);
      stub.receiveComponent({props: {dataSet: {id: 42}, ariaSet: {id: 20}}}, transaction);
